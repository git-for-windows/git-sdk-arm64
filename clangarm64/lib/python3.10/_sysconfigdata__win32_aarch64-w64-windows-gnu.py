...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BINLIBDEST': '/clangarm64/lib/python3.10',
 ...
 'CONFIG_ARGS': "'--prefix=/clangarm64' '--host=aarch64-w64-mingw32' "
                ...
                "'host_alias=aarch64-w64-mingw32' 'CC=clang' 'CFLAGS=-O2 -pipe "
 ...
 'CONFINCLUDEPY': '/clangarm64/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/c/M/mingw-w64-python/src/build-CLANGARM64/coverage.info',
 'COVERAGE_REPORT': '/c/M/mingw-w64-python/src/build-CLANGARM64/lcov-report',
 ...
 'DESTDIR': '',
 'DESTDIRFINAL': '/',
 'DESTDIRS': '/clangarm64 /clangarm64/lib /clangarm64/lib/python3.10 '
             '/clangarm64/lib/python3.10/lib-dynload',
 'DESTLIB': '/clangarm64/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/clangarm64/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cp310-mingw_aarch64.pyd',
 'FILEMODE': 644,
 ...
 'INCLDIRSTOMAKE': '/clangarm64/include /clangarm64/include '
                   '/clangarm64/include/python3.10 '
                   '/clangarm64/include/python3.10',
 'INCLUDEDIR': '/clangarm64/include',
 'INCLUDEPY': '/clangarm64/include/python3.10',
 ...
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/clangarm64/lib/python3.10',
 ...
 'LIBPL': '/clangarm64/lib/python3.10/config-3.10',
 ...
 'MACHDESTLIB': '/clangarm64/lib/python3.10',
 ...
 'MODULE_OBJS': '\\',
 'MULTIARCH': 'aarch64-w64-windows-gnu',
 'MULTIARCH_CPPFLAGS': '-DMULTIARCH=\\"aarch64-w64-windows-gnu\\"',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             ...
                             '-O3 -std=c99 -Wextra -Wno-unused-result '
                             '-Wno-unused-parameter '
                             '-Wno-missing-field-initializers '
                             '-Wstrict-prototypes '
                             '-Werror=implicit-function-declaration '
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -fwrapv -O3 -Wall -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 '
              '-fstack-protector-strong -O3 -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 '
              '-fstack-protector-strong -O3',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   ...
                   '-DMS_DLL_ID=\'"3.10-arm64"\' '
                   '-fprofile-instr-use=code.profclangd '
                   '-I../Python-3.10.9/Include/internal -IObjects -IInclude '
                   '-IPython -I. -I../Python-3.10.9/Include '
                   '-I../Python-3.10.9/PC -D__USE_MINGW_ANSI_STDIO=1 -I. '
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                        ...
                        '-Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong -O3 '
                        '-O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 '
                        '-fstack-protector-strong -O3 -std=c99 -Wextra '
 ...
 'VENVLAUNCHERDIR': '/clangarm64/lib/python3.10/venv/scripts/nt',
 'VERSION': '3.10',
 ...
 'abs_builddir': 'C:/M/mingw-w64-python/src/build-CLANGARM64',
 'abs_builddir_b2h': 'C:/M/mingw-w64-python/src/build-CLANGARM64',
