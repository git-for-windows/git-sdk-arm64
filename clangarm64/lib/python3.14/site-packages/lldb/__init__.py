...
swig_version = (_to_int(0x040401 // 0x10000), _to_int(0x040401 // 0x100), _to_int(0x040401))
del _to_int
...
LLDB_UNWINDER_FRAME_LIST_ID = _lldb.LLDB_UNWINDER_FRAME_LIST_ID

LLDB_INVALID_SIGNAL_NUMBER = _lldb.LLDB_INVALID_SIGNAL_NUMBER

LLDB_INVALID_SYMBOL_ID = _lldb.LLDB_INVALID_SYMBOL_ID
...
LLDB_INVALID_GLOBALLY_UNIQUE_TARGET_ID = _lldb.LLDB_INVALID_GLOBALLY_UNIQUE_TARGET_ID
...
eInstrumentationRuntimeTypeBoundsSafety = _lldb.eInstrumentationRuntimeTypeBoundsSafety
...
eBasicTypeFloat128 = _lldb.eBasicTypeFloat128
...
eExceptionStageCreate = _lldb.eExceptionStageCreate

eExceptionStageThrow = _lldb.eExceptionStageThrow

eExceptionStageReThrow = _lldb.eExceptionStageReThrow

eExceptionStageCatch = _lldb.eExceptionStageCatch

eNameMatchStyleAuto = _lldb.eNameMatchStyleAuto

eNameMatchStyleFull = _lldb.eNameMatchStyleFull

eNameMatchStyleBase = _lldb.eNameMatchStyleBase

eNameMatchStyleMethod = _lldb.eNameMatchStyleMethod
...
class SBSaveCoreOptions(object):
    ...
    * eSaveCoreCustomOnly Custom defers entirely to the SBSaveCoreOptions object and will only save what is specified. Picking custom and specifying nothing will result in an error being returned.
    ...
    def GetProcess(self):
        r"""
        GetProcess(SBSaveCoreOptions self) -> SBProcess
        ...
        """
        return _lldb.SBSaveCoreOptions_GetProcess(self)
    ...
    def GetMemoryRegionsToSave(self):
        r"""
        GetMemoryRegionsToSave(SBSaveCoreOptions self) -> SBMemoryRegionInfoList
        ...
        """
        return _lldb.SBSaveCoreOptions_GetMemoryRegionsToSave(self)
...
class SBDebugger(object):
    ...
    def FindTargetByGloballyUniqueID(self, id):
        r"""Find a target with the specified unique ID."""
        return _lldb.SBDebugger_FindTargetByGloballyUniqueID(self, id)
...
class SBError(object):
    ...
    def IsValid(self):
        r"""
        Returns ``true`` if this object contains an underlying ``Status``
        object.

        That object may represent a success or a failure. When ``IsValid`` returns
        ``false``, it may be the case that the ``SBError`` represents a success but
        does not contain a ``Status`` representing that success.

        It is safe to call ``Success`` or ``Fail`` in the case where ``IsValid``
        returns ``false``.
        """
...
class SBFileSpec(object):
    ...
    def GetPath(self, dst_path):
        r"""GetPath(SBFileSpec self, char * dst_path) -> uint32_t"""
        return _lldb.SBFileSpec_GetPath(self, dst_path)

    @staticmethod
    def ResolvePath(src_path, dst_path):
        r"""ResolvePath(char const * src_path, char * dst_path) -> int"""
        return _lldb.SBFileSpec_ResolvePath(src_path, dst_path)
...
class SBFunction(object):
    ...
    def GetBaseName(self):
        r"""GetBaseName(SBFunction self) -> char const *"""
        return _lldb.SBFunction_GetBaseName(self)
...
class SBModule(object):
    ...
    def GetObjectName(self):
        ...
        nullptr.
        """
        return _lldb.SBModule_GetObjectName(self)
...
class SBMutex(object):
    ...
    def try_lock(self):
        ...
        """
        return _lldb.SBMutex_try_lock(self)
...
class SBPlatform(object):
    ...
    def IsHost(self):
        r"""Returns true if this platform is the host platform, otherwise false."""
        return _lldb.SBPlatform_IsHost(self)
...
class SBSymbol(object):
    ...
    def GetBaseName(self):
        r"""GetBaseName(SBSymbol self) -> char const *"""
        return _lldb.SBSymbol_GetBaseName(self)
    ...
    def GetID(self):
        ...
        """
        return _lldb.SBSymbol_GetID(self)
    ...
    def IsDebug(self):
        r"""Returns true if the symbol is a debug symbol."""
        return _lldb.SBSymbol_IsDebug(self)

    @staticmethod
    def GetTypeAsString(symbol_type):
        r"""Get the string representation of a symbol type."""
        return _lldb.SBSymbol_GetTypeAsString(symbol_type)

    @staticmethod
    def GetTypeFromString(str):
        r"""Get the symbol type from a string representation."""
        return _lldb.SBSymbol_GetTypeFromString(str)
...
class SBTarget(object):
    ...
    eBroadcastBitNewTargetCreated = _lldb.SBTarget_eBroadcastBitNewTargetCreated
    ...
    @staticmethod
    def GetCreatedTargetFromEvent(event):
        r"""
        ...
        """
        return _lldb.SBTarget_GetCreatedTargetFromEvent(event)
    ...
    def GetArchName(self):
        r"""GetArchName(SBTarget self) -> char const *"""
        return _lldb.SBTarget_GetArchName(self)
    ...
    def GetGloballyUniqueID(self):
        ...
        """
        return _lldb.SBTarget_GetGloballyUniqueID(self)

    def GetTargetSessionName(self):
        r"""
        ...
        """
        return _lldb.SBTarget_GetTargetSessionName(self)
    ...
    def RegisterScriptedFrameProvider(self, class_name, args_dict, error):
        r"""
        ...
        """
        return _lldb.SBTarget_RegisterScriptedFrameProvider(self, class_name, args_dict, error)

    def RemoveScriptedFrameProvider(self, provider_id):
        r"""
        ...
        :return: 
                An error object indicating success or failure.
        """
        return _lldb.SBTarget_RemoveScriptedFrameProvider(self, provider_id)
...
class SBThread(object):
    ...
    def GetStopDescription(self, *args):
        r"""
        GetStopDescription(SBThread self, SBStream stream) -> bool
...
class SBValue(object):
    ...
    def GetDescription(self, *args):
        ...
        GetDescription(SBValue self, SBStream description, lldb::DescriptionLevel description_level) -> bool
        """
