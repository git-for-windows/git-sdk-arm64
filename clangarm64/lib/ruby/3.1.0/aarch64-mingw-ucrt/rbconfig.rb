...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.1.0/aarch64-mingw-ucrt")
  ...
  CONFIG["configure_args"] = " '--prefix=/clangarm64' '--build=aarch64-w64-mingw32' '--host=aarch64-w64-mingw32' '--target=aarch64-w64-mingw32' '--disable-werror' '--with-setjmp-type=setjmp' '--with-soname=$$(RUBY_BASE_NAME)$$(MAJOR)$$(MINOR)0' 'build_alias=aarch64-w64-mingw32' 'host_alias=aarch64-w64-mingw32' 'target_alias=aarch64-w64-mingw32' 'CC=clang' 'CXX=clang++' 'CFLAGS=-O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong -I/clangarm64/include/pdcurses  -Wno-unknown-attributes' 'LDFLAGS=' 'CPPFLAGS=-D__USE_MINGW_ANSI_STDIO=1 -DFD_SETSIZE=2048  -I/clangarm64/include/pdcurses' 'CXXFLAGS=-O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong -I/clangarm64/include/pdcurses  -Wno-unknown-attributes'"
  ...
  CONFIG["CP"] = "cp"
  CONFIG["RM"] = "rm -f"
  CONFIG["PKG_CONFIG"] = "aarch64-w64-mingw32-pkg-config"
  ...
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "clang version 18.1.4\nTarget: aarch64-w64-windows-gnu\nThread model: posix\nInstalledDir: C:/msys64/clangarm64/bin"
  CONFIG["CC_VERSION"] = "$(CC) --version"
  CONFIG["MJIT_CC"] = "C:/msys64/clangarm64/bin/clang.exe"
  CONFIG["CSRCFLAG"] = ""
  CONFIG["COUTFLAG"] = "-o "
  CONFIG["OUTFLAG"] = "-o "
  ...
  CONFIG["GCC"] = "yes"
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong -I/clangarm64/include/pdcurses  -Wno-unknown-attributes -fdeclspec"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-D__USE_MINGW_ANSI_STDIO=1 -DFD_SETSIZE=2048  -I/clangarm64/include/pdcurses -D_WIN32_WINNT=0x0600 -D__MINGW_USE_VC2005_COMPAT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. "
  CONFIG["CFLAGS"] = "-O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong -I/clangarm64/include/pdcurses  -Wno-unknown-attributes $(cflags)"
  ...
  CONFIG["target_alias"] = "aarch64-w64-mingw32"
  CONFIG["host_alias"] = "aarch64-w64-mingw32"
