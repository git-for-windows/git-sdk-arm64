...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/4.0.0/aarch64-mingw-ucrt")
  ...
  CONFIG["RUBY_INSTALL_NAME"] = "$(RUBY_BASE_NAME)"
  CONFIG["RUBY_SO_NAME"] = "aarch64-ucrt-$(RUBY_BASE_NAME)$(MAJOR)$(MINOR)0"
  CONFIG["exec"] = "exec"
  CONFIG["ruby_pc"] = "ruby-4.0.pc"
  CONFIG["CC_WRAPPER"] = ""
  CONFIG["PACKAGE"] = "ruby"
  ...
  CONFIG["configure_args"] = " '--prefix=/clangarm64' '--disable-install-doc' '--without-baseruby' '--with-setjmp-type=setjmp' 'CC=clang' 'CXX=clang++' 'CFLAGS=-march=armv8.1-a -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong -Wp,-D__USE_MINGW_ANSI_STDIO=1' 'LDFLAGS=' 'CPPFLAGS=' 'CXXFLAGS=-march=armv8.1-a -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong -Wp,-D__USE_MINGW_ANSI_STDIO=1'"
  ...
  CONFIG["sitearch"] = "aarch64-ucrt"
  CONFIG["arch"] = "aarch64-mingw-ucrt"
  ...
  CONFIG["EXTLDFLAGS"] = ""
  CONFIG["hardenflags"] = "-fstack-protector-strong"
  CONFIG["strict_warnflags"] = ""
  CONFIG["warnflags"] = "-Wall -Wextra -Wextra-tokens -Wdeprecated-declarations -Wdivision-by-zero -Wdiv-by-zero -Wimplicit-function-declaration -Wimplicit-int -Wpointer-arith -Wno-shorten-64-to-32 -Wwrite-strings -Wold-style-definition -Wmissing-noreturn -Wno-cast-function-type -Wno-constant-logical-operand -Wno-long-long -Wno-missing-field-initializers -Wno-overlength-strings -Wno-parentheses-equality -Wno-self-assign -Wno-tautological-compare -Wno-unused-parameter -Wno-unused-value -Wunused-variable -Wmisleading-indentation -Wundef"
  ...
  CONFIG["ZJIT_OBJ"] = ""
  CONFIG["ZJIT_LIBS"] = ""
  CONFIG["ZJIT_SUPPORT"] = "no"
  CONFIG["YJIT_OBJ"] = ""
  CONFIG["YJIT_LIBS"] = ""
  CONFIG["YJIT_SUPPORT"] = "no"
  CONFIG["CARGO_BUILD_ARGS"] = ""
  CONFIG["JIT_RUST_FLAGS"] = "--crate-type=staticlib --cfg feature=\\\\\\\"stats_allocator\\\\\\\""
  CONFIG["ZJIT_TEST_FEATURES"] = ""
  CONFIG["CARGO"] = ""
  CONFIG["RUSTC"] = "no"
  ...
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "clang version 22.1.8 (https://github.com/msys2/MINGW-packages 6e4e79c2f86eeb534e324e583f2057dc9fd5ecab)\nTarget: aarch64-w64-windows-gnu\nThread model: posix\nInstalledDir: C:/M/msys64/clangarm64/bin"
  ...
  CONFIG["GCC"] = "yes"
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-march=armv8.1-a -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong -Wp,-D__USE_MINGW_ANSI_STDIO=1 -fdeclspec"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-D_WIN32_WINNT=0x0600 -D__MINGW_USE_VC2005_COMPAT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -fstack-protector-strong"
  CONFIG["CFLAGS"] = "-march=armv8.1-a -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong -Wp,-D__USE_MINGW_ANSI_STDIO=1 $(cflags)"
  CONFIG["STRIP"] = "llvm-strip -S -x"
  CONFIG["RANLIB"] = "llvm-ranlib"
  CONFIG["OBJDUMP"] = "llvm-objdump"
  CONFIG["OBJCOPY"] = "llvm-objcopy"
  CONFIG["NM"] = "llvm-nm --no-llvm-bc"
  CONFIG["LD"] = "ld"
  CONFIG["CXX"] = "clang++"
  CONFIG["AS"] = "as"
  CONFIG["AR"] = "llvm-ar"
  ...
  CONFIG["wasmoptflags"] = ""
  CONFIG["WASMOPT"] = ""
  CONFIG["config_target"] = "aarch64-w64-mingw32"
  ...
  CONFIG["build"] = "aarch64-w64-mingw32"
  ...
  CONFIG["HAVE_GIT"] = "no"
  CONFIG["GIT"] = "never-use"
  CONFIG["cxxflags"] = ""
  CONFIG["cppflags"] = ""
  CONFIG["cflags"] = "$(hardenflags) -fdeclspec  $(optflags) $(debugflags) $(warnflags)"
  CONFIG["MAKEDIRS"] = "/usr/bin/mkdir -p"
  CONFIG["target_alias"] = ""
  CONFIG["host_alias"] = "$(target_alias)"
  CONFIG["build_alias"] = "aarch64-w64-mingw32"
