...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.3.0/aarch64-mingw-ucrt")
  ...
  CONFIG["ASFLAGS"] = "-mbranch-protection=pac-ret"
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "clang version 19.1.4\nTarget: aarch64-w64-windows-gnu\nThread model: posix\nInstalledDir: C:/msys64/clangarm64/bin"
