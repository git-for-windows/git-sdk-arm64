...
# installed.
TK_PREFIX='/clangarm64'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/clangarm64'
...
# build directory.
TK_BUILD_LIB_SPEC='-Wl,/clangarm64/lib/libtk86.dll.a'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/clangarm64/lib -ltk86'
...
# compiled.
TK_SRC_DIR='/clangarm64/include/tk8.6/tk-private'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-Wl,/clangarm64/lib/libtkstub86.a'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/clangarm64/lib -ltkstub86'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/clangarm64/lib/libtkstub86.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/clangarm64/lib/libtkstub86.a'
# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TK_INCLUDE_SPEC='-I/clangarm64/include/tk8.6'
